...
func (e *eddsaKey) newEDDSA() (*ed25519.PublicKey, error) {
	// compressed format = 0x40 + public point
	var point = e.ecdsaKey.p.bytes[1:]
...
func (e *eddsaKey) byteLen() int {
	return 1 + len(e.oid) + 2 + len(e.p.bytes)
}
